...
{
    public class UpdateArcticleCommand : IRequest<UpdateArticleResponse>
    {
        ...
        public class UpdateArticleCommandHandler : BaseHandler, IRequestHandler<UpdateArcticleCommand, UpdateArticleResponse>
        {
            ...
            public async Task<UpdateArticleResponse> Handle(UpdateArcticleCommand request, CancellationToken cancellationToken)
            {
